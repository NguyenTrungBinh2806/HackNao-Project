...
public class U18_TruyenChem extends AppCompatActivity {
    ImageButton Btn;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Txt1.setText(R.string.u18);
        Txt0.setText(R.string.u18t);
        TxtContent.setText(R.string.u18tc);
        mediaPlayer = MediaPlayer.create(this,R.raw.unit18);
        Btn.setOnClickListener(v ->{
            Intent intent = new Intent(U18_TruyenChem.this, TruyenChem.class);
