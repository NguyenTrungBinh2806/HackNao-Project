...
public class U14_TruyenChem extends AppCompatActivity {
    ImageButton Btn;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Txt1.setText(R.string.u14);
        Txt0.setText(R.string.u14t);
        TxtContent.setText(R.string.u14tc);
        mediaPlayer = MediaPlayer.create(this,R.raw.unit14);
        Btn.setOnClickListener(v ->{
            Intent intent = new Intent(U14_TruyenChem.this, TruyenChem.class);
