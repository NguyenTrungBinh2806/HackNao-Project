...
public class U24_TruyenChem extends AppCompatActivity {
    ImageButton Btn;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Txt1.setText(R.string.u24);
        Txt0.setText(R.string.u24t);
        TxtContent.setText(R.string.u24tc);
        mediaPlayer = MediaPlayer.create(this,R.raw.unit24);
        Btn.setOnClickListener(v ->{
            Intent intent = new Intent(U24_TruyenChem.this, TruyenChem.class);
