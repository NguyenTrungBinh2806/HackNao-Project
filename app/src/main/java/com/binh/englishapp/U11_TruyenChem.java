...
public class U11_TruyenChem extends AppCompatActivity {
    ImageButton Btn;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Txt1.setText(R.string.u11);
        Txt0.setText(R.string.u11t);
        TxtContent.setText(R.string.u11tc);
        mediaPlayer = MediaPlayer.create(this,R.raw.unit11);
        Btn.setOnClickListener(v ->{
            Intent intent = new Intent(U11_TruyenChem.this, TruyenChem.class);
