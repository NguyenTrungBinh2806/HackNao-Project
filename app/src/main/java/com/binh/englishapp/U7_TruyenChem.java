...
public class U7_TruyenChem extends AppCompatActivity {
    ImageButton Btn;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Txt1.setText(R.string.u7);
        Txt0.setText(R.string.u7t);
        TxtContent.setText(R.string.u7tc);
        mediaPlayer = MediaPlayer.create(this,R.raw.unit07);
        Btn.setOnClickListener(v ->{
            Intent intent = new Intent(U7_TruyenChem.this, TruyenChem.class);
