...
public class U5_LuyenTap extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (pos >= list.size()) {
                    Intent intent = new Intent(U5_LuyenTap.this,activity_ketqua.class);
    ...
    private void ReadFirebase() {
        ...
        myRef.child("Unit5").addValueEventListener(new ValueEventListener() {
            @Override
    ...
    private void CanhBao(){
        ...
        AlertDialog.setPositiveButton("Thoát", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
                Intent intent = new Intent(U5_LuyenTap.this, LuyenTap.class);
                startActivity(intent);
                finish();
            }
        });
