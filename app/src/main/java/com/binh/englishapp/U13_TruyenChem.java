...
public class U13_TruyenChem extends AppCompatActivity {
    ImageButton Btn;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Txt1.setText(R.string.u13);
        Txt0.setText(R.string.u13t);
        TxtContent.setText(R.string.u13tc);
        mediaPlayer = MediaPlayer.create(this,R.raw.unit13);
        Btn.setOnClickListener(v ->{
            Intent intent = new Intent(U13_TruyenChem.this, TruyenChem.class);
