...
public class U5_TruyenChem extends AppCompatActivity {
    ImageButton Btn;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Txt1.setText(R.string.u5);
        Txt0.setText(R.string.u5t);
        TxtContent.setText(R.string.u5tc);
        mediaPlayer = MediaPlayer.create(this,R.raw.unit05);
        Btn.setOnClickListener(v ->{
            Intent intent = new Intent(U5_TruyenChem.this, TruyenChem.class);
