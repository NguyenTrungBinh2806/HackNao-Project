...
public class U17_TruyenChem extends AppCompatActivity {
    ImageButton Btn;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Txt1.setText(R.string.u17);
        Txt0.setText(R.string.u17t);
        TxtContent.setText(R.string.u17tc);
        mediaPlayer = MediaPlayer.create(this,R.raw.unit17);
        Btn.setOnClickListener(v ->{
            Intent intent = new Intent(U17_TruyenChem.this, TruyenChem.class);
