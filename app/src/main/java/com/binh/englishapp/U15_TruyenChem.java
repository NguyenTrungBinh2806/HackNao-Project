...
public class U15_TruyenChem extends AppCompatActivity {
    ImageButton Btn;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Txt1.setText(R.string.u15);
        Txt0.setText(R.string.u15t);
        TxtContent.setText(R.string.u15tc);
        mediaPlayer = MediaPlayer.create(this,R.raw.unit15);
        Btn.setOnClickListener(v ->{
            Intent intent = new Intent(U15_TruyenChem.this, TruyenChem.class);
