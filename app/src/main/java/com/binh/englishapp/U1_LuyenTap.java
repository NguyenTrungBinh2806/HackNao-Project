...
public class U1_LuyenTap extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Back.setOnClickListener(v -> {
            CanhBao();
            //Intent intent = new Intent(U1_LuyenTap.this, LuyenTap.class);
        ...
        btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (pos >= list.size()) {
                    Intent intent = new Intent(U1_LuyenTap.this,activity_ketqua.class);
    ...
    private void ReadFirebase() {
        ...
        myRef.child("Unit1").addValueEventListener(new ValueEventListener() {
            @Override
