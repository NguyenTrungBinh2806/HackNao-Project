...
public class U4_TruyenChem extends AppCompatActivity {
    ImageButton Btn;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Txt1.setText(R.string.u4);
        Txt0.setText(R.string.u4t);
        TxtContent.setText(R.string.u4tc);
        mediaPlayer = MediaPlayer.create(this,R.raw.unit04);
        Btn.setOnClickListener(v ->{
            Intent intent = new Intent(U4_TruyenChem.this, TruyenChem.class);
