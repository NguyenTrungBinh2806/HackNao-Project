...
public class U3_TruyenChem extends AppCompatActivity {
    ImageButton Btn;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mediaPlayer = MediaPlayer.create(this,R.raw.unit03);
        Btn.setOnClickListener(v ->{
            Intent intent = new Intent(U3_TruyenChem.this, TruyenChem.class);
