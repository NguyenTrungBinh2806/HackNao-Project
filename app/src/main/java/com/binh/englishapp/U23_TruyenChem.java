...
public class U23_TruyenChem extends AppCompatActivity {
    ImageButton Btn;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Txt1.setText(R.string.u23);
        Txt0.setText(R.string.u23t);
        TxtContent.setText(R.string.u23tc);
        mediaPlayer = MediaPlayer.create(this,R.raw.unit23);
        Btn.setOnClickListener(v ->{
            Intent intent = new Intent(U23_TruyenChem.this, TruyenChem.class);
