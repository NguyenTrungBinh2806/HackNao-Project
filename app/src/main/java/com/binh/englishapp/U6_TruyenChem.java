...
public class U6_TruyenChem extends AppCompatActivity {
    ImageButton Btn;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Txt1.setText(R.string.u6);
        Txt0.setText(R.string.u6t);
        TxtContent.setText(R.string.u6tc);
        mediaPlayer = MediaPlayer.create(this,R.raw.unit06);
        Btn.setOnClickListener(v ->{
            Intent intent = new Intent(U6_TruyenChem.this, TruyenChem.class);
