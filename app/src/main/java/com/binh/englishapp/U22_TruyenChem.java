...
public class U22_TruyenChem extends AppCompatActivity {
    ImageButton Btn;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Txt1.setText(R.string.u22);
        Txt0.setText(R.string.u22t);
        TxtContent.setText(R.string.u22tc);
        mediaPlayer = MediaPlayer.create(this,R.raw.unit22);
        Btn.setOnClickListener(v ->{
            Intent intent = new Intent(U22_TruyenChem.this, TruyenChem.class);
