...
public class U16_TruyenChem extends AppCompatActivity {
    ImageButton Btn;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Txt1.setText(R.string.u16);
        Txt0.setText(R.string.u16t);
        TxtContent.setText(R.string.u16tc);
        mediaPlayer = MediaPlayer.create(this,R.raw.unit16);
        Btn.setOnClickListener(v ->{
            Intent intent = new Intent(U16_TruyenChem.this, TruyenChem.class);
