...
public class U9_TruyenChem extends AppCompatActivity {
    ImageButton Btn;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Txt1.setText(R.string.u9);
        Txt0.setText(R.string.u9t);
        TxtContent.setText(R.string.u9tc);
        mediaPlayer = MediaPlayer.create(this,R.raw.unit09);
        Btn.setOnClickListener(v ->{
            Intent intent = new Intent(U9_TruyenChem.this, TruyenChem.class);
