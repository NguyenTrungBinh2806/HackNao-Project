...
public class U25_TruyenChem extends AppCompatActivity {
    ImageButton Btn;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Txt1.setText(R.string.u25);
        Txt0.setText(R.string.u25t);
        TxtContent.setText(R.string.u25tc);
        mediaPlayer = MediaPlayer.create(this,R.raw.unit25);
        Btn.setOnClickListener(v ->{
            Intent intent = new Intent(U25_TruyenChem.this, TruyenChem.class);
