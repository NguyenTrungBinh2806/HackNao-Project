...
public class U20_TruyenChem extends AppCompatActivity {
    ImageButton Btn;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Txt1.setText(R.string.u20);
        Txt0.setText(R.string.u20t);
        TxtContent.setText(R.string.u20tc);
        mediaPlayer = MediaPlayer.create(this,R.raw.unit20);
        Btn.setOnClickListener(v ->{
            Intent intent = new Intent(U20_TruyenChem.this, TruyenChem.class);
