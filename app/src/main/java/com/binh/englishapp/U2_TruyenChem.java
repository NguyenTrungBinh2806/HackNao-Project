...
public class U2_TruyenChem extends AppCompatActivity {
    ImageButton Btn;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Txt1.setText(R.string.u2);
        Txt0.setText(R.string.u2t);
        TxtContent.setText(R.string.u2tc);
        mediaPlayer = MediaPlayer.create(this,R.raw.unit02);
        Btn.setOnClickListener(v ->{
            Intent intent = new Intent(U2_TruyenChem.this, TruyenChem.class);
