...
public class U19_TruyenChem extends AppCompatActivity {
    ImageButton Btn;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Txt1.setText(R.string.u19);
        Txt0.setText(R.string.u19t);
        TxtContent.setText(R.string.u19tc);
        mediaPlayer = MediaPlayer.create(this,R.raw.unit19);
        Btn.setOnClickListener(v ->{
            Intent intent = new Intent(U19_TruyenChem.this, TruyenChem.class);
