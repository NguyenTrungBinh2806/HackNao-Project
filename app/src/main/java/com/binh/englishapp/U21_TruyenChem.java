...
public class U21_TruyenChem extends AppCompatActivity {
    ImageButton Btn;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Txt1.setText(R.string.u21);
        Txt0.setText(R.string.u21t);
        TxtContent.setText(R.string.u21tc);
        mediaPlayer = MediaPlayer.create(this,R.raw.unit21);
        Btn.setOnClickListener(v ->{
            Intent intent = new Intent(U21_TruyenChem.this, TruyenChem.class);
